...
void OGraphicsEngine::setWindigOrder(const OWindingOrder& type)
{
	auto orderType = GL_CW;

	if (type == OWindingOrder::ClockWise) orderType = GL_CW;
	else if (type == OWindingOrder::CounterClockWise) orderType = GL_CCW;
